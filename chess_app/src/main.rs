...
mod tests {
    ...
    fn test_queen_movement() {
        let mut game = Game::new();
        game.set_field((4, 4), chessman::Queen::new(Position{row: 4, column: 4}, PlayerKind::White, ChessmanStatus::NotCaptured));
        let result  = game.make_move((4, 4));
    ...
    fn test_king_movement() {
        let mut game = Game::new();
        game.set_field((4, 4), chessman::King::new(Position{row: 4, column: 4}, PlayerKind::White, ChessmanStatus::NotCaptured));
        let result  = game.make_move((4, 4));
    ...
    fn test_bishop_movement() {
        let mut game = Game::new();
        game.set_field((4, 4), chessman::Bishop::new(Position{row: 4, column: 4}, PlayerKind::White, ChessmanStatus::NotCaptured));
        let result  = game.make_move((4, 4));
    ...
    fn test_knight_movement() {
        let mut game = Game::new();
        game.set_field((4, 4), chessman::Knight::new(Position{row: 4, column: 4}, PlayerKind::White, ChessmanStatus::NotCaptured));
        let result  = game.make_move((4, 4));
        assert_eq!(result.unwrap().len(), 8);
    }
